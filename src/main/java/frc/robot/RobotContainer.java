...
import frc.robot.subsystems.PickerSubsystem.PickerStates;
...
public class RobotContainer {
  ...
  private final PickerSubsystem m_picker = new PickerSubsystem();
  ...
  private void configureButtonBindings() {
    ...
    m_driverController.rightTrigger()
        .onTrue(new RunCommand(() -> m_robotDrive.setMaxOutput(0.5)))
        .onFalse(new RunCommand(() -> m_robotDrive.setMaxOutput(1)));

    m_driverController.x()
        .onTrue(new InstantCommand(() -> m_picker.setState(PickerStates.PICKING)))
        .onFalse(new InstantCommand(() -> m_picker.setState(PickerStates.IDLING)));
    m_driverController.y()
        .onTrue(new InstantCommand(() -> m_picker.setState(PickerStates.EJECTING)))
        .onFalse(new InstantCommand(() -> m_picker.setState(PickerStates.IDLING)));

    m_driverController.a()
        .onTrue(new InstantCommand(() -> m_shooter.setState(ShooterStates.SHOOTING)))
        .onFalse(new InstantCommand(() -> m_shooter.setState(ShooterStates.IDLING)));
  }
  ...
  public Command getAutonomousCommand() {
    ...
    Trajectory exampleTrajectory =
        TrajectoryGenerator.generateTrajectory(
            ...
            List.of(new Translation2d(2, 3), new Translation2d(3, 1), new Translation2d(6, 6)),
